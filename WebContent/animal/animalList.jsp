	        ...
	        <c:forEach var="animal" items="${animalList}"> 
	          <div class="col-md-6">
	        	<table>  		 				
		          		<tr>	
		          			<td rowspan ="4"> 
		          			<a href="<c:url value='/animal/detail'>
						   		<c:param name='animalID' value='${animal.animalID}'/><c:param name='currentPage' value='${currentPage}'/>
				 		 	</c:url>">
 ...
 <nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
  	<c:forEach var="i" begin="1" end="${totalPage}" step="1">
    	<li class="page-item"><a class="page-link" href="<c:url value='/animal/animalList'><c:param name='currentPage' value='${i}'/></c:url>">${i}</a></li>
    </c:forEach>
  </ul>	      
</nav>
 </div>
